...
window.scroll(newX,newY)},1000/60)};$(function(){var container=$(".whatsapp__button__container");var active="whatsapp__button__container--active";$("#whatsapp").click(function(e){e.stopPropagation();container.toggleClass(active);if(container.hasClass(active)){$(document).click(function(){container.removeClass(active)})}})});const screenPosition=window.innerHeight/2;function animationAboutUs(){const aboutUs=document.querySelector('.aboutUs');const aboutUsPosition=aboutUs.getBoundingClientRect().top;if(aboutUsPosition<screenPosition){aboutUs.classList.add('aboutUs--animation')}}
