...
window.addEventListener('scroll',animationSteps);function animationTestimonial(){const testimonial=document.querySelector('.testimonial');const testimonialPosition=testimonial.getBoundingClientRect().top;if(testimonialPosition<screenPosition){testimonial.classList.add('testimonial--animation')}}
...
window.addEventListener('scroll',animationOffice);/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */
