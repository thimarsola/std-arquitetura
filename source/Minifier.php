...
$minJs->add(dirname(__DIR__, 1) . "/assets/js/theme/whatsapp.js");
...
$minResidentialJs->add(dirname(__DIR__, 1) . "/assets/js/theme/whatsapp.js");
...
$minCommercialJs->add(dirname(__DIR__, 1) . "/assets/js/theme/whatsapp.js");
...
$minSingleJs->add(dirname(__DIR__, 1) . "/assets/js/theme/whatsapp.js");
