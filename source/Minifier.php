...
$minCss->add(dirname(__DIR__, 1) . "/assets/css/styles.css");
$minCss->add(dirname(__DIR__, 1) . "/assets/css/theme/home/sweetalert2.min.css");
$minCss->minify(dirname(__DIR__, 1) . "/assets/css/styles.min.css");
