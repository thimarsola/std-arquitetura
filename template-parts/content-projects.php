<!-- card -->
<article class="projects__content__layout__card">

    <!-- header -->
    <header class="projects__content__layout__card__header d-none">
        <h3><?php the_title(); ?></h3>
    </header>
    <!-- end of header -->

    <!-- body -->
    <div class="projects__content__layout__card__body">
